...
Add the code necessary to create a Web API and implement the following
_endpoints_:
...
- If the user is found and the new information is valid:
  ...
  - update the user document in the database using the new information sent in
    the `request body`.
...
- the React application can be anywhere, but, for this project create it inside
  the folder for the solution.
- connect to the `/api/users` endpoint in the API and show the list of users.
- add a delete button to each displayed user that will remove it from the
  server.
